...
pub const UPDATE_CHECK_INTERVAL_SECS: u64 = 86400; // 24 hours
...
pub const DEFAULT_POLICY_MINIMUM_RELEASE_AGE_MINS: u64 = 1440; // 24 hours
pub const DEFAULT_POLICY_ALLOW_POSTINSTALL: bool = false;
pub const DEFAULT_POLICY_TRUST_POLICY: &str = "none";
pub const DEFAULT_POLICY_TRUST_POLICY_IGNORE_AFTER_MINS: u64 = 10080; // 7 days
...
pub const POPULAR_PACKAGES_REFRESH_SECS: u64 = 7 * 24 * 60 * 60; // 7 days
...
// Default allowed download domains
...
pub const SANDBOX_WINDOWS_JOB_MEMORY_LIMIT: usize = 512 * 1024 * 1024; // 512 MB
